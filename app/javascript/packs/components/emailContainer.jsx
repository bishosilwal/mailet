        ...
        <div className='row justify-content-center pb-5'>
          ...
          <div className='col-12'>
            ...
            <div className='row justify-content-center p-2'>
              <div className='col-md-5 w-sm-60 w-l-60 w-sm-45-90'>
                <h2>
          ...
          <div className='col-md-8 col-sm-12 pt-2 w-sm-80'>
            <div className='row justify-content-around action-pills'>
              <div className='col-md-3 col-sm-12 w-sm-40 mt-sm-2 w-l-40 m-sm-45-10'>
                <div className='btn btn-primary rounded-pill p-3 text-center' onClick={this.handleChange} data-toggle="tooltip" data-placement="bottom" title="Change mail address">
              ...
              <div className='col-md-3 col-sm-12 w-sm-40 mt-sm-2 w-l-40 m-sm-45-10'>
                <div className='btn btn-primary rounded-pill p-3 text-center' onClick={this.handleDelete} data-toggle="tooltip" data-placement="bottom" title="Delete and create new mail address">
                  <span className='float-left ml-1'>
              ...
              <div className='col-md-3 col-sm-12 w-sm-40 mt-sm-2 w-l-40 m-sm-45-10'>
                <div className='btn btn-primary rounded-pill p-3 text-center' onClick={this.createMessage} data-toggle="tooltip" data-placement="bottom" title="Send email using current mail address">
                  <span className='float-left ml-1'>
              ...
              <div className='col-md-3 col-sm-12 w-sm-40 mt-sm-2 w-l-40 m-sm-45-10'>
                <div className='btn btn-primary rounded-pill p-3 text-center' onClick={this.allMessages} data-toggle="tooltip" data-placement="bottom" title="List all received mails">
                  <span className='float-left ml-1'>
